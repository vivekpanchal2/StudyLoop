      ...
      >
        ...
        <div className="px-4">
          ...
          <div className="flex flex-col gap-4">
            <button
              className="cursor-pointer rounded-md bg-yellow-50 px-[20px] py-[8px] font-semibold text-richblack-900 hover:bg-white hover:text-black duration-300 outline-none"
              onClick={
